...
| Solvari-profiel bestaat | Live page `https://www.solvari.nl/airco/groningen/pekela/green-installatie-noord-oude-pekela` | YES (link only) | “Bekijk ervaringen op Solvari” — no stars, no quote |
...
| “Gecertificeerde installateurs” | Unverified | Solvari profile text — not used | Named scheme and persons |
| A-merken | Unverified | Solvari / older copy | Brand list the company actually installs, plus logo licence |
...
| Solvari-partner als keurmerk | Not treated as a certificate | Marketplace listing ≠ quality mark | Do not badge |
| Solvari-review (1×, 5/5, 26 maart 2025) | Profile seen; republication not cleared | Platform/reviewer reuse terms unknown; quote not copied | Written permission, then set `republicationAllowed` and `approved` |
