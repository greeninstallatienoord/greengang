  ...
  shot(
    {
      ...
      title: 'Ketel in technische ruimte',
      caption: 'Cv-ketel met rookgasafvoer.',
      category: 'cv-ketel',
      href: '/cv-ketel',
    },
  ...
  shot(
    {
      ...
      title: 'Warmtepomp',
      caption: 'Warmtepomp-buitenunit bij de woning.',
      category: 'warmtepomp',
      href: '/warmtepomp',
    },
    { kind: 'buitenunit' },
  ...
  shot(
    {
      ...
      title: 'Technische opstelling',
      caption: 'Ketelopstelling met vat en leidingwerk.',
      category: 'cv-ketel',
      href: '/cv-ketel',
    },
    { kind: 'technische-installatie' },
