...
export const workPhotos = {
  ...
  aircoOmkasting: photo(
    ...
    1350,
    1800,
    'Buitenunit in een antraciete omkasting bij de gevel, met leiding omhoog',
    '62% 72%',
    '68% 80%',
  ),
  ...
  aircoTerras: photo(
    ...
    1448,
    1086,
    'Midea airco-buitenunit op dempers op een plat dakterras',
    '68% 58%',
    '72% 62%',
  ),
  aircoBeugel: photo(
    ...
    1350,
    1800,
    'Buitenunit aan een bakstenen gevel op een beugel, met witte leidinggoot',
    '36% 48%',
    '32% 46%',
  ),
  aircoKaisai: photo(
  ...
  aircoPlatdak: photo(
    ...
    1350,
    1800,
    'Warmtepomp-buitenunit op trillingsdempers op een plat dak',
    '50% 48%',
    '50% 52%',
  ),
  aircoMuur: photo(
    ...
    1350,
    1800,
    'Buitenunit tegen een bakstenen gevel met leidinggoot en elektra',
    '32% 58%',
    '28% 62%',
  ),
  ...
  cvOpstelling: photo(
    ...
    1350,
    1800,
    'Hybride installatie met Nefit-ketel, Remeha Elga Ace en geïsoleerd leidingwerk in een technische ruimte',
    '50% 45%',
    '50% 42%',
  ),
  cvIntergas: photo(
    ...
    1086,
    1448,
    'Intergas cv-ketel / hybride warmtepomp van Green Installatie Noord met leidingwerk en rookgasafvoer in een technische ruimte',
    '50% 42%',
    '50% 40%',
  ),
...
export const homeProjectShots: WorkShot[] = [
  ...
  },
  {
    ...
    title: 'Intergas cv-ketel / hybride warmtepomp',
    caption: 'Intergas cv-ketel met hybride warmtepomp-binnenunit en leidingwerk in een technische ruimte.',
    category: 'warmtepomp',
